...
const teamData = [
  {
    ...
    socials: [<FaFacebookF />, <FaLinkedinIn />, <FaTwitter />],
    active: true,
  },
  { img: teamTwo, title: "CS:GO" },
  { img: teamThree, title: "DOTA 2" },
  { img: teamFour, title: "VALORANT" },
];
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 mt-10">
          {teamData.map((member, index) => (
            ...
            >
              ...
              {!member.active && (
                <h3 className="absolute bottom-5 left-5 text-white text-[18px] sm:text-[20px] font-semibold z-10">
                  {member.title}
                </h3>
              )}
            </div>
